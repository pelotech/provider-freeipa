...
export TERRAFORM_PROVIDER_SOURCE ?= rework-space-com/freeipa
export TERRAFORM_PROVIDER_REPO ?= https://github.com/rework-space-com/terraform-provider-freeipa
export TERRAFORM_PROVIDER_VERSION ?= 5.0.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-freeipa
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/rework-space-com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-freeipa_v5.0.0
...
xpkg.build.provider-freeipa: do.build.images
