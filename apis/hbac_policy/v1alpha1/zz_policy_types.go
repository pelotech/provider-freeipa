...
type PolicyInitParameters struct {
	...
	// (String) HBAC policy description
	// HBAC policy description
	Description *string `json:"description,omitempty" tf:"description,omitempty"`

	// (Boolean) Enable this hbac policy
	// Enable this hbac policy
	Enabled *bool `json:"enabled,omitempty" tf:"enabled,omitempty"`

	// (String) Host category the hbac policy is applied to (allowed value: all)
	...
	// (String) Name of the hbac policy
	// Name of the hbac policy
	Name *string `json:"name,omitempty" tf:"name,omitempty"`

	// (String) Service category the hbac policy is applied to (allowed value: all)
	// Service category the hbac policy is applied to (allowed value: all)
	Servicecategory *string `json:"servicecategory,omitempty" tf:"servicecategory,omitempty"`

	// (String) User category the hbac policy is applied to (allowed value: all)
...
// Policy is the Schema for the Policys API. FreeIPA HBAC policy resource
