...
type HostgroupInitParameters struct {

	// (String) Hostgroup Description
...
type HostgroupSpec struct {
	...
	// autoscaler.
	InitProvider HostgroupInitParameters `json:"initProvider,omitempty"`
}
...
// Hostgroup is the Schema for the Hostgroups API. FreeIPA User Group resource
